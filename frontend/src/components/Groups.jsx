...
import { getGroupByUserId } from "../redux/slices/group";
...
const Groups = () => {
  ...
  return (
    <div className=" ">
      ...
      >
       <span className="px-[8px] group-hover:bg-purple-900 group-hover:text-white text  text-center bg-white rounded-full text-purple-900">+</span>    Create Group{" "}
      </div>
      <div>
        {groups?.map((e) => {
          return (
            <div
              className="px-5 text-slate-300 hover:text-purple-900 hover:bg-white" key={e._id}
